<template>
  <RouterLink
    ...
    :to="linkTarget"
    class="nav-chevron"
    :class="[directionClass, themeClass]"
...
const themeClass = computed(() => {
  return props.darkMode ? "nav-chevron--dark" : "nav-chevron--light";
});
...
/* Dark mode - white icon for dark background */
.nav-chevron--dark .nav-chevron__icon {
  color: #ffffff;
}

/* Light mode - dark icon for light background */
.nav-chevron--light .nav-chevron__icon {
  color: #000000;
}
