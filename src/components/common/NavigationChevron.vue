...
const props = defineProps({
  type: {
    type: String,
    default: "route",
    validator: (value) => ["route", "back"].includes(value),
  },
  to: {
    type: [String, Object],
    default: null,
  ...
  direction: {
    type: String,
    default: "forward",
    validator: (value) => ["forward", "back"].includes(value),
  },
  ariaLabel: {
    type: String,
    default: null,
...
const directionClass = computed(() =>
  props.direction === "back" ? "nav-chevron--back" : "nav-chevron--forward"
);
...
const computedAriaLabel = computed(() => {
  ...
  return props.type === "back" ? "Go back" : "Open link";
});
