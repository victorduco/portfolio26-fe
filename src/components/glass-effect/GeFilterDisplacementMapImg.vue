...
const props = defineProps({
  ...
  shaderRectWidth: { type: Number, required: true },
  shaderRectHeight: { type: Number, required: true },
  shaderCenterOffsetX: { type: Number, required: true },
  shaderCenterOffsetY: { type: Number, required: true },
  shaderEdgeSoftness: { type: Number, required: true },
...
const generateShaderDisplacementMap = () => {
  const generator = new ShaderDisplacementGenerator({
    ...
    rectWidth: props.shaderRectWidth,
    rectHeight: props.shaderRectHeight,
    centerOffsetX: props.shaderCenterOffsetX,
    centerOffsetY: props.shaderCenterOffsetY,
    edgeSoftness: props.shaderEdgeSoftness,
...
watch(
  () => [
    ...
    props.shaderRectWidth,
    props.shaderRectHeight,
    props.shaderCenterOffsetX,
    props.shaderCenterOffsetY,
    props.shaderEdgeSoftness,
