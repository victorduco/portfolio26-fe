    ...
    sections: [
      {
        ...
        media: cards('/images/story3-challenge-1.png', '/images/story3-challenge-3.png', '/images/story3-challenge-2.png', 'Typical field conditions: rain, safety equipment, and a tablet with a protective screen.', {}, [
          { targetImage: 'left', position: { x: 50, y: 40 }, text: 'Fragmented workflows caused confusion', buttonColor: '#ca4034' },
          { targetImage: 'center', position: { x: 50, y: 50 }, text: 'Harsh field conditions require robust UX', buttonColor: '#ca4034' },
          { targetImage: 'right', position: { x: 50, y: 45 }, text: 'Protective equipment limits interaction', buttonColor: '#ca4034' }
        ]),
      },
      {
        ...
        media: img('/images/story3-task.png', 'Previous version: Home screen, My Tasks (two views), and user profile.', [
          { position: { x: 25, y: 35 }, text: 'Complex navigation patterns', buttonColor: '#ca4034' },
          { position: { x: 50, y: 50 }, text: 'Cluttered task management interface', buttonColor: '#ca4034' },
          { position: { x: 75, y: 40 }, text: 'Inconsistent user profile design', buttonColor: '#ca4034' }
        ]),
      },
    ],
  },
