export const storyConfigs = {
  ...
  3: {
    ...
    simpleResults: {
      ...
      text: "The redesigned operator experience addressed all major usability issues and provided engineering with a clear implementation blueprint. The new version is now in development and progressing toward release.",
    },
